    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".content", function() {
            ...
            if ($(this).hasClass("tour-item")) {
                url = "${pageContext.request.contextPath}/index/tourInfo?contentId=" + contentId + "&contentTypeId=" + contentTypeId;
            } else if ($(this).hasClass("event-item")) {
                url = "${pageContext.request.contextPath}/index/eventInfo?contentId=" + contentId + "&contentTypeId=" + contentTypeId;
            }
