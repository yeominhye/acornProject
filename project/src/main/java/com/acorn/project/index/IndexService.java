	                    ...
	                    if (eventArr != null) {
	                        ...
	                        for (int i = 0; i < eventArr.length(); i++) {
	                            ...
	                            EventDTO3 edetail = new EventDTO3(item.getString("firstimage"), item.getString("overview"),
	                                    item.getDouble("mapx"), item.getDouble("mapy"), item.getString("addr1"),item.getString("title"));
		                    ...
		                    if (tourArr != null) {
		                        ...
		                        for (int i = 0; i < tourArr.length(); i++) {
		                            ...
		                            TourDTO_dist tour = new TourDTO_dist(item.optString("title"), item.optString("firstimage"),
		                                    ...
		                                    item.optString("contentid"), item.optString("contenttypeid"), item.optDouble("mapx"),
		                                    item.optDouble("mapy"));
		                            tourList.add(tour);
		                        }
		                        System.out.println(tourList);
	                    ...
	                    if (tourArr != null) {
	                        ...
	                        for (int i = 0; i < tourArr.length(); i++) {
	                            ...
	                            TourDTO2 tdetail = new TourDTO2(item.optString("title"), item.optString("tel"),
	                                    ...
	                                    item.optString("addr2"), item.optString("mapx"), item.optString("mapy"),
